import sys
from PyQt5.QtWidgets import QApplication, QMainWindow, QLabel, QPushButton, QFileDialog, QTextEdit, QVBoxLayout, QWidget, QMessageBox, QHBoxLayout
...
class ImageSteganographyApp(QMainWindow):
    ...
    def addIcon(self):
        ...
        icon_label.setPixmap(pixmap.scaled(500, 250))
        ...
        self.centralWidget.layout().addLayout(h_layout)
